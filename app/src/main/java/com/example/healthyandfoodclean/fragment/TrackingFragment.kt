...
import android.view.*
import com.example.healthyandfoodclean.ui.MainViewModel
...
import com.example.healthyandfoodclean.other.Constants.Companion.MAP_VIEW_BUNDLE_KEY
import com.example.healthyandfoodclean.other.Constants.Companion.MAP_ZOOM
import com.example.healthyandfoodclean.other.Constants.Companion.POLYLINE_COLOR
import com.example.healthyandfoodclean.other.Constants.Companion.POLYLINE_WIDTH
...
const val CANCEL_DIALOG_TAG = "CancelDialog"
 //   set up action Google map
@AndroidEntryPoint
class TrackingFragment : Fragment(R.layout.activity_running) {
